            ...
            <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
                <div className="bg-black border border-white font-mont-bold rounded-3xl p-5 w-full max-w-98 shadow-2xl relative mt-10">
                    ...
                    <div className="text-center mb-6 ">
                        <h2 className="text-xl font-bold text-white mb-1 ">1. REGÍSTRATE PARA PARTICIPAR</h2>
                    ...
                    <form onSubmit={handleRegisterSubmit} className="space-y-4 text-start">
                        ...
                        {/* Input Nombre */}
                        <div>
                            <label className="block text-white text-sm font-bold mb-1 ml-4">Nombres y Apellidos</label>
                            <input 
                                type="text" 
                                ...
                                required
                                className="w-full px-5 py-2 bg-black border border-white rounded-full text-white placeholder-gray-500 focus:outline-none focus:border-[#65c7c3] focus:ring-1 focus:ring-[#65c7c3] transition-colors"
                            />
                        </div>

                        {/* Input DNI */}
                        <div>
                            <label className="block text-white text-sm font-bold mb-1 ml-4">Número de DNI</label>
                            <input 
                                type="tel" 
                        ...
                        {/* Input Email */}
                        <div>
                            <label className="block text-white text-sm font-bold mb-1 ml-4">Correo Electrónico</label>
                            <input 
                                type="email" 
